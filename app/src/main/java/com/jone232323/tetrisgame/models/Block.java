...
import com.jone232323.tetrisgame.constants.FieldConstants;
...
public class Block {
    ...
    public enum BlockColor{
        ...
        ORANGE(Color.rgb(255,140,180),(byte) 4),
    ...
    public final byte[][] getShape(int frameNumber){
        return  Shape.values()[shapeIndex].getFrame(frameNumber).as2dOfByteArray();
    }
